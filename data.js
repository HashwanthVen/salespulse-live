...
window.SALESPULSE_DATA = {
  ...
  topDeals: [
    { account: "Northwind Industries",   stage: "Negotiation",  amount: 2400000, prob: 75, close: "2026-06-28", owner: "S. Rivera",   forecast: "commit",   region: "NA",   segment: "Enterprise",  motion: "new",       nextStep: null,                                                                                                  engagement: { score: 78, lastTouchDays:  3, touchpoints14d:  8, multiThreaded: true,  trend: "down" }, meddic: { M: true,  E: true,  D1: false, D2: false, I: true,  C: false, P: false, Cm: true  } },
    { account: "Contoso Manufacturing",  stage: "Proposal",     amount: 1850000, prob: 60, close: "2026-07-15", owner: "L. Patel",    forecast: "bestcase", region: "EMEA", segment: "Enterprise",  motion: "expansion", nextStep: { action: "Pricing approval",      dueDate: "2026-06-15", daysFromNow:  3 }, engagement: { score: 82, lastTouchDays:  2, touchpoints14d: 10, multiThreaded: true,  trend: "up"   }, meddic: { M: true,  E: true,  D1: true,  D2: false, I: true,  C: true,  P: false, Cm: true  } },
    { account: "Fabrikam Logistics",     stage: "Discovery",    amount: 1200000, prob: 35, close: "2026-08-10", owner: "M. Chen",     forecast: "upside",   region: "APAC", segment: "Mid-Market",  motion: "new",       nextStep: null,                                                                                                  engagement: { score: 28, lastTouchDays: 21, touchpoints14d:  1, multiThreaded: false, trend: "down" }, meddic: { M: true,  E: false, D1: false, D2: false, I: true,  C: false, P: false, Cm: false } },
    { account: "Adventure Works",        stage: "Negotiation",  amount: 1100000, prob: 80, close: "2026-06-25", owner: "S. Rivera",   forecast: "commit",   region: "NA",   segment: "Enterprise",  motion: "expansion", nextStep: { action: "Mutual close plan",     dueDate: "2026-06-18", daysFromNow:  6 }, engagement: { score: 88, lastTouchDays:  1, touchpoints14d: 12, multiThreaded: true,  trend: "up"   }, meddic: { M: true,  E: true,  D1: true,  D2: true,  I: true,  C: true,  P: false, Cm: true  } },
    { account: "Tailwind Traders",       stage: "Proposal",     amount:  980000, prob: 55, close: "2026-07-08", owner: "J. Okafor",   forecast: "bestcase", region: "NA",   segment: "Enterprise",  motion: "new",       nextStep: { action: "Demo with CTO",         dueDate: "2026-06-17", daysFromNow:  5 }, engagement: { score: 72, lastTouchDays:  4, touchpoints14d:  6, multiThreaded: true,  trend: "flat" }, meddic: { M: true,  E: true,  D1: false, D2: false, I: true,  C: true,  P: false, Cm: true  } },
    { account: "Wide World Importers",   stage: "Qualified",    amount:  860000, prob: 25, close: "2026-08-22", owner: "L. Patel",    forecast: "upside",   region: "EMEA", segment: "Mid-Market",  motion: "new",       nextStep: { action: "Champion meeting",      dueDate: "2026-06-14", daysFromNow:  2 }, engagement: { score: 58, lastTouchDays:  8, touchpoints14d:  4, multiThreaded: false, trend: "flat" }, meddic: { M: true,  E: false, D1: false, D2: false, I: true,  C: false, P: false, Cm: true  } },
    { account: "Lucerne Publishing",     stage: "Negotiation",  amount:  720000, prob: 70, close: "2026-06-30", owner: "M. Chen",     forecast: "commit",   region: "EMEA", segment: "Mid-Market",  motion: "new",       nextStep: { action: "Legal redline",         dueDate: "2026-06-05", daysFromNow: -7 }, engagement: { score: 42, lastTouchDays: 11, touchpoints14d:  2, multiThreaded: false, trend: "down" }, meddic: { M: true,  E: true,  D1: true,  D2: false, I: true,  C: false, P: false, Cm: true  } },
    { account: "Litware Inc.",           stage: "Proposal",     amount:  680000, prob: 50, close: "2026-07-20", owner: "K. Yamada",   forecast: "bestcase", region: "APAC", segment: "Enterprise",  motion: "expansion", nextStep: { action: "Security questionnaire", dueDate: "2026-06-16", daysFromNow:  4 }, engagement: { score: 51, lastTouchDays:  9, touchpoints14d:  3, multiThreaded: true,  trend: "down" }, meddic: { M: true,  E: false, D1: false, D2: false, I: true,  C: false, P: false, Cm: true  } },
    { account: "Proseware Systems",      stage: "Discovery",    amount:  540000, prob: 30, close: "2026-08-30", owner: "J. Okafor",   forecast: "upside",   region: "NA",   segment: "Mid-Market",  motion: "new",       nextStep: { action: "Procurement review",    dueDate: "2026-06-19", daysFromNow:  7 }, engagement: { score: 68, lastTouchDays:  5, touchpoints14d:  5, multiThreaded: true,  trend: "flat" }, meddic: { M: true,  E: true,  D1: false, D2: false, I: true,  C: true,  P: false, Cm: false } },
    { account: "Margie's Travel",        stage: "Negotiation",  amount:  480000, prob: 65, close: "2026-07-05", owner: "S. Rivera",   forecast: "commit",   region: "NA",   segment: "SMB",         motion: "expansion", nextStep: { action: "Renewal terms",         dueDate: "2026-06-09", daysFromNow: -3 }, engagement: { score: 64, lastTouchDays:  6, touchpoints14d:  4, multiThreaded: true,  trend: "flat" }, meddic: { M: true,  E: true,  D1: true,  D2: false, I: true,  C: true,  P: false, Cm: true  } },
    { account: "Trey Research",          stage: "Proposal",     amount:  420000, prob: 55, close: "2026-07-18", owner: "L. Patel",    forecast: "bestcase", region: "EMEA", segment: "Mid-Market",  motion: "expansion", nextStep: { action: "Pricing approval",      dueDate: "2026-06-13", daysFromNow:  1 }, engagement: { score: 76, lastTouchDays:  3, touchpoints14d:  7, multiThreaded: true,  trend: "up"   }, meddic: { M: true,  E: true,  D1: true,  D2: false, I: true,  C: false, P: false, Cm: true  } },
    { account: "Graphic Design Inst.",   stage: "Negotiation",  amount:  380000, prob: 85, close: "2026-06-20", owner: "M. Chen",     forecast: "commit",   region: "APAC", segment: "SMB",         motion: "new",       nextStep: { action: "Demo with CTO",         dueDate: "2026-06-15", daysFromNow:  3 }, engagement: { score: 85, lastTouchDays:  2, touchpoints14d:  9, multiThreaded: true,  trend: "up"   }, meddic: { M: true,  E: true,  D1: true,  D2: true,  I: true,  C: true,  P: false, Cm: true  } }
  ],
